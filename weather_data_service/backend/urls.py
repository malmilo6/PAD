...
from .views import WeatherDataViewSet, HealthCheck, WeatherPredictionViewSet, AlertSync2PC, AlertSaga
...
url_patterns = [
    ...
    path('alert-saga/<str:action>/', AlertSaga.as_view(), name='alert_saga'),
]