...
urlpatterns = [
    ...
    path('user-alert-preference-2pc/', CreateAlertPreference2PC.as_view(), name='user-alert-preference-2pc'),
    path('user-alert-preference-saga/', CreateAlertPreferenceSaga.as_view(), name='user-alert-preference-saga'),
