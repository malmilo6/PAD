"""
Django settings for user_alert_service project.
...
SECRET_KEY = 'django-insecure-x7qtzxm_*fyx+7^0c-4*fm7@e5$41%8y7e^9c5+%d5m+bxt@x*'
...
WSGI_APPLICATION = 'user_alert_service.wsgi.application'
